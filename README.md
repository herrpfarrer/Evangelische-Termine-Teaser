...
### unter Joomla 3.x  
1. Laden Sie die aktuelle Version des Moduls herunter. Klicken Sie dazu hier: [Download](https://github.com/herrpfarrer/Evangelische-Termine-Teaser/releases/download/1.0/etteaserv1.0.zip). Sie brauchen die heruntergeladene Datei nicht zu entpacken.
